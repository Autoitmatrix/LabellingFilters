# -*- coding: utf-8 -*-
"""Step1CollectingActivationsFINAL.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ocQCm31tRKA-Siv6JXxUoznLzUsAqZcD
...
for i,layer in enumerate(cnn.layers):
  if 'conv' not in layer.name:
    continue
  layers.append(i)
logger.info("interesting layers are "+str(layers))
...
def get_activations(prep_images,method,cnn,layers,classnum,maxclass):
  ...
  for step in range(num_pics):
    logger.info("collect, scale and combine activations for image "+str(step+1)+" of "+str(num_pics) +" (class "+str(classnum+1) +" of "+str(maxclass)+")")
